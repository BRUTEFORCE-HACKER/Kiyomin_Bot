...
const first = numberOfOnePage * page - numberOfOnePage;
    ...
    const siu = ` 》『Joel Comendador | ${global.config.BOTNAME}』\nPage 『${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}』`;
 ...
 const text = `\n━━━━━━━━━━━━━━━━\n\n╰┈➤2023 ${global.config.BOTNAME} Bot | Joel Comendador\n\n❈:Command Length: ${arrayInfo.length}\n✥:Bot Name: ${global.config.BOTNAME}\n❅:Prefix: ${global.config.PREFIX}`;
    var link = [
"https://media.giphy.com/media/8Lc5xmvzRhlLy/giphy.gif",      
"https://media.giphy.com/media/8Lc5xmvzRhlLy/giphy.gif",    
"https://media.giphy.com/media/8Lc5xmvzRhlLy/giphy.gif",    
"https://media.giphy.com/media/U6IQE5XjiF5hm/giphy.gif",    
"https://media.giphy.com/media/eXKUC4ic17m7u/giphy.gif",
"https://media.giphy.com/media/3ohc0PsZLDN5Dgcf5e/giphy.gif",
"https://media.giphy.com/media/3ohc0PsZLDN5Dgcf5e/giphy.gif",
    ]
     var callback = () => api.sendMessage({ body: siu + "\n\n" + msg  + text, attachment: fs.createReadStream(__dirname + "/cache/loidbutter.gif")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/loidbutter.gif"), event.messageID);
    return request(encodeURI(link[Math.floor(Math.random() * link.length)])).pipe(fs.createWriteStream(__dirname + "/cache/loidbutter.gif")).on("close", () => callback());
 }
